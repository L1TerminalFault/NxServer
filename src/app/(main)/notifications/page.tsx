        ...
        <>
          ...
          {!isSignedIn ? null : loadingMessages ? (
            ...
            <Show when="signed-in">
              <div
                onClick={refresh}
                className={`${!subscribed ? "hidden" : ""} select-none fixed flex items-center gap-2 z-20 backdrop-blur-xl md:bottom-24 bottom-28 right-9 text-lg rounded-full shadow-lg shadow-black/30 bg-white/10 hover:bg-white/15 transition-all //py-1.5 p-2 cursor-pointer`}
              >
