...
export default function TitleBar() {
  return (
    <div className="z-50">
      <div className="w-full shadow-lg shadow-black/30 flex items-center justify-between fixed top-0 p-2 px-5 text-xl //border-b-gray-700/30 //border //border-transparent backdrop-blur-lg transition-all bg-transparent">
